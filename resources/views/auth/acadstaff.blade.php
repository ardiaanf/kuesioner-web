...
<head>
    <title>Masuk sebagai tenaga kependidikan</title>
    <meta charset="utf-8">
...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="bg-white border border-gray-300 p-6 rounded-lg shadow-md w-80">
        <h2 class="text-lg font-semibold text-center mb-4">Masuk sebagai Tenaga kependidikan</h2> <!-- Judul yang lebih jelas -->
        <form>
            @csrf
