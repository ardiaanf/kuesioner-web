...
<body class="bg-gray-100">
    ...
    <div id="edit-modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
     ...
     <div id="detail-modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg p-6 w-2/3 max-h-3/4 overflow-y-auto"> <!-- Ubah lebar modal menjadi w-2/3 -->
            ...
            <div id="detail-elements" class="mb-2"></div> <!-- Tambahkan elemen untuk menampilkan lecturer_elements -->
    ...
    <script>
                ...
                const row = `
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b">
                            ...
                            <button class="bg-green-500 text-white px-4 py-2 rounded" onclick="showDetails('${questionnaire.id}')">Detail</button> <!-- Tambahkan tombol Detail -->
                        </td>
                    </tr>
                `;
        ...
        async function showDetails(id) {
            ...
            try {
                const response = await fetch(`${BASE_URL}/api/admin/lecturer-questionnaires/${id}/relations`, {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Accept': 'application/json'
                    }
    ...
    <style>
        ...
        #detail-modal .bg-white {
            max-height: 80vh; /* Maksimal tinggi modal */
