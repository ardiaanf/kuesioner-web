...
<body class="bg-gray-100">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
                <div class="container mx-auto px-6 py-8">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h1 class="text-2xl font-bold mb-4">Jenis Kuesioner Mahasiswa</h1>
                        <p class="text-gray-600 mb-4">Data ini digunakan untuk mengumpulkan data jenis kuesioner mahasiswa.</p>
                            ...
                            <table class="min-w-full bg-white border border-gray-300">
                                <thead>
                                    <tr class="bg-gray-100">
                                        ...
                                        <th class="py-2 px-4 border-b border-r">Jenis Kuesioner</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="py-2 px-4 border-b border-r">Kuesioner PBM semester ganjil</td>
                                        <td class="py-2 px-4 border-b border-r">PBM </td>
                                        <td class="py-2 px-4 border-b">
                                            <button class="bg-yellow-500 text-white px-4 py-2 rounded" onclick="openEditModal('Kuesioner PBM semester ganjil', 'PBM')">Ubah</button>
    ...
    <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg p-6 w-1/3">
            ...
            <input type="text" class="border border-gray-300 rounded w-full mb-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400" placeholder=" Masukkan jenis kuesioner">
    ...
    <div id="edit-modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg p-6 w-1/3">
            ...
            <label class="block mb-2">Jenis Kuesioner</label>
            <input type="text" id="edit-jenis" class="border border-gray-300 rounded w-full mb-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400">
