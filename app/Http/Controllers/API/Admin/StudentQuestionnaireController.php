...
use App\Http\Resources\StudentQuestionnaireResource;
...
class StudentQuestionnaireController extends BaseController
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->role == 'admin') {
            ...
            return $this->successResponse(new StudentQuestionnaireResource($studentQuestionnaire), 'Student Questionnaire created successfully');
        } else {
            return $this->errorResponse('Unauthorized', [], 401);
        }
    }
